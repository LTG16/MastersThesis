...
#######################################################################################
#EM Q unrestricted and F unrestricted for simulated Data
#######################################################################################
...
#estimate <- function(x,y,P.new,P.smoothed,phi,gamma,d2){
...
while(converged == FALSE && num_iter < 10000){
  ...
  Est <- estimate(x=s$m_s_n,y=y,P.new=s$P_s_n,P.smoothed=s$P_s_nn1)
