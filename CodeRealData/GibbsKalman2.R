...
# Nugget effect
sigma_R <- 0.03709048
#Parameters obtained by the Gibbs Sampler, unrestricted F
H1 = diag(length(sites))
F1 = matrix(c(0.5372265,0.09213085,0.2231448 ,0.07664844,1.1709278,0.78044463,2.8117975,-3.81855949,-1.6193114,0.32362526,-1.0068321,3.24486245,-0.8184830,0.21312888,-0.7004760,2.24922745),nrow=4,ncol=4)
F1 <- t(F1)
#Q1 = C_0 - C_1%*%solve(C_0)%*%C_1
R1 = sigma_R * diag(length(sites))
phi_start<-0.1595736
sigma_eta_start<-0.2031234
